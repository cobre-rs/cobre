...
**Ratified 2026-09-18** — owner gate; baseline `077dbe2c`; accepted 44, downgraded 0, rejected 0, deferred 0, overridden 0; 22 prior ids ratified (3 retire → Cleared, 11 keep, 8 sharpen); 1 hold closed by its alternative; 1 re-baseline accepted; 43 needs-human answered.
...
**Cleared by the owner gate (2026-09-18) — ratified retires, do not re-raise:**

- **CD-001 — CLI crate hand-rolled a mirror of the rank-0 stochastic pipeline** — retired, resolved by `b051c410`; single owner is `build_stochastic_context_for_study`; anchor `crates/cobre-sddp/src/setup/stochastic_pipeline.rs::build_stochastic_context_for_study`.
- **CD-003-construction-hop — the BroadcastConfig → ConstructionConfig manual copy (Construction hop)** — retired, resolved by `4075c4e8`; ConstructionConfig deleted; the two-carrier residue is CD-004's business; anchor `crates/cobre-sddp/src/setup/params.rs::from_config`.
- **CD-006 — NodeGraph query surface scattered as free functions** — retired, resolved by `3f4c3db3`; the free functions are now `impl NodeGraph` methods; anchor `crates/cobre-sddp/src/setup/node_graph.rs::frontier_node`.
...
- **Alignment (E9):** I.3-7 — CD-004 (reused) + CD-082; I.3-8 — TD-045; every `advances-*` row above is provisional. The CD-024-successor `conflicts` hold was asked ALONE at the owner gate (2026-09-18) and CLOSED by its alternative: the per-rank derivation stays and rides CD-004's projection; no id promoted. Rows and directions in `stations/sddp/alignment-queue.json`.
...
Ratified 2026-09-18 in the main session over the digest in `stations/sddp/gate.md` (15 AskUserQuestion calls: round 0 over the 22 prior ids in three groups, three severity batches, the CD-024-successor hold alone, the CD-005 re-baseline alone, 43 needs-human items four to a call, the handoff confirmation). Every answer was the recommended option. Machine-readable record: `stations/sddp/decisions.json`; E9 rows: `stations/sddp/alignment-queue.json`. No fix executed, no measurement run, no figure asserted.

**Prior Wave 4/6/7 dispositions (round 0, 22 ids).** Decision column written back into the disposition table above.

| ID | Wave | Presented | Owner decision | Closing commit | Rationale |
| -- | -- | -- | -- | -- | -- |
| CD-001 | 4 | retire | ratified → Cleared | b051c410 | as recorded (R0-retire) |
| CD-003-construction-hop | 4 | retire | ratified → Cleared | 4075c4e8 | as recorded (R0-retire) |
| CD-006 | 4 | retire | ratified → Cleared | 3f4c3db3 | as recorded (R0-retire) |
| CD-004 | 4 | sharpen | ratified | - | as recorded (R0-sharpen) |
| CD-005 | 4 | sharpen | ratified | - | as recorded (R0-sharpen); re-baseline accepted (R5): Accept with re-baseline (Recommended) — CD-005 stays accepted; the fix lands only behind a parity re-baseline that names all three bars, with the NCS fields moved as one unit · R6-nh-1: Remove… |
| CD-024-successor | 4 | sharpen | ratified | - | as recorded (R0-sharpen); hold closed by its alternative (R4): Take the alternative (Recommended) — die: the per-rank derivation stays; CD-024-successor rides CD-004's single Config projection; no broadcast seam, no id promoted; the hold closes… |
| CD-015 | 6 | sharpen | ratified | - | as recorded (R0-sharpen) |
| CD-022 | 6 | sharpen | ratified | - | as recorded (R0-sharpen) |
| CD-018 | 6 | keep | ratified | - | as recorded (R0-keep) |
| CD-035 | 6 | keep | ratified | - | as recorded (R0-keep) |
| CD-034 | 6 | keep | ratified | - | as recorded (R0-keep) |
| CD-023 | 6 | sharpen | ratified | - | as recorded (R0-sharpen) |
| CD-021 | 7 | sharpen | ratified | - | as recorded (R0-sharpen) |
| CD-007 | 7 | sharpen | ratified | - | as recorded (R0-sharpen) |
| CD-012 | 7 | keep | ratified | - | as recorded (R0-keep) |
| CD-014-remnant | 7 | keep | ratified | - | as recorded (R0-keep) |
| CD-016 | 7 | keep | ratified | - | as recorded (R0-keep) |
| CD-028 | 7 | keep | ratified | - | as recorded (R0-keep); R6-nh-21: Module-doc correction only; no code hoist — claim_scatter.rs's module-doc consumer list is corrected to name simulation/enumerated.rs; the four-line worker-result fold stays inline at both sites; CD-028's skel… |
| CD-030 | 7 | keep | ratified | - | as recorded (R0-keep) |
| CD-037 | 7 | keep | ratified | - | as recorded (R0-keep) |
| CD-038 | 7 | keep | ratified | - | as recorded (R0-keep) |
| OD-009 | 7 | keep | ratified | - | as recorded (R0-keep) |

**New entries (rounds 1-3).** Severity shown as `house (reviewer: original)` where the calibration downgraded; the gate downgraded none.

| ID | Decision | Severity | Alignment | Rationale (owner) | Trigger / override / handoff |
| -- | -- | -- | -- | -- | -- |
| CD-084 | accept | B (A-risk) (reviewer: A) | neutral | as recorded (R1) | R6-nh-38: Rejected at validation; latent, fix byte-neutral |
| CD-086 | accept | B (A-risk) (⬆ from B) | neutral | as recorded (R1) | R6-nh-19: Road (a): reject the pairing at admission; R6-nh-20: In scope; severity stays B (A-risk) |
| CD-082 | accept | B | advances-0a | as recorded (R2) | E9 cross-ref I.3-7; R6-nh-2: Construction-time check, get stays infallible |
| CD-085 | accept | B | advances-0b | as recorded (R2) | E9; R6-nh-11: Bounded to seams/traits/crates; the accessor is fine |
| OD-040 | accept | B | neutral | as recorded (R2) | R6-nh-29: Correct the mirror sentence down to D4; R6-nh-30: Re-file the residue against cobre-io at E11 |
| PD-036 | accept | B | neutral | as recorded (R2) | E10: 4t, UNMEASURED, kept; R6-nh-6: NodeGraph field, land with the accessor residue |
| PD-038 | accept | B | neutral | as recorded (R2) | E10: 4t, UNMEASURED, kept |
| PD-039 | accept | B | neutral | as recorded (R2) | E10: 4t, UNMEASURED, kept; R6-nh-15: Treat as a warm-start-chain change; clear all three bars in E10 |
| PD-040 | accept | B | neutral | as recorded (R2) | E10: 4t, UNMEASURED, kept; R6-nh-22: Correct the sentence inside PD-040's fix |
| PD-041 | accept | B | neutral | as recorded (R2) | E10: 4t, UNMEASURED, kept |
| PD-042 | accept | B | neutral | as recorded (R2) | E10: 4t, UNMEASURED, kept; R6-nh-23: Keep the over-inclusion; shared-block fix only |
| PD-044 | accept | B | neutral | as recorded (R2) | E10: 4t, UNMEASURED, kept |
| PD-045 | accept | B | neutral | as recorded (R2) | E10: 4t, UNMEASURED, kept; R6-nh-32: StageContext, span-only |
| PD-047 | accept | B | neutral | as recorded (R2) | E10: 4t, UNMEASURED, kept |
| TD-042 | accept | B | neutral | as recorded (R2) | E08; R6-nh-7: Uniform spread + one canary literal; no Default derive |
| TD-043 | accept | B | neutral | as recorded (R2) | E08 |
| TD-044 | accept | B | neutral | as recorded (R2) | E08; R6-nh-8: Per-binary hoist now; cross-binary lift is E08's call |
| TD-045 | accept | B | advances-1 | as recorded (R2) | E08; E9 cross-ref I.3-8; R6-nh-9: Consolidate behind test-support; E07 fixes the workflow |
| TD-049 | accept | B | neutral | as recorded (R2) | E08; R6-nh-18: Spec-layer extension, with the collapse as its first step |
| TD-053 | accept | B | neutral | as recorded (R2) | E08; R6-nh-25: cobre-sddp test-support surface |
| TD-054 | accept | B | neutral | as recorded (R2) | E08; R6-nh-26: cfg-gated declarative macro in test_support.rs |
| CD-083 | accept | C | neutral | as recorded (R3) | R6-nh-3: Remove, batched with the public-API break |
| CD-087 | accept | C (reviewer: B) | advances-0b | as recorded (R3) | E9; R6-nh-27: Retire the private half now; public half in the API-break batch |
| CD-088 | accept | C | advances-0a | as recorded (R3) | E9; R6-nh-28: Land with 0a's shared output orchestration |
| OD-036 | accept | C | neutral | as recorded (R3) | - |
| OD-037 | accept | C (reviewer: B) | advances-0b | as recorded (R3) | E9; R6-nh-12: Batch with the next licensed public-API break / 0b carve |
| OD-038 | accept | C (reviewer: B) | advances-0b | as recorded (R3) | E9; R6-nh-13: Batch with the next licensed public-API break / 0b carve; R6-nh-14: Joins OD-038 |
| OD-039 | accept | C | neutral | as recorded (R3) | R6-nh-41: Route the two-comment correction to E07 |
| OD-041 | accept | C | neutral | as recorded (R3) | R6-nh-31: Crate-wide pass over the 25 sites with a forcing check |
| OD-042 | accept | C | neutral | as recorded (R3) | - |
| PD-035 | accept | C | neutral | as recorded (R3) | R6-nh-5: Symmetric fill only, no re-baseline |
| PD-037 | accept | C (reviewer: B) | neutral | as recorded (R3) | - |
| PD-043 | accept | C | neutral | as recorded (R3) | R6-nh-42: Keep the unconditional recount; PD-043 is the slot-table clear only |
| PD-046 | accept | C (reviewer: B) | neutral | as recorded (R3) | - |
| PD-048 | accept | C (reviewer: B) | neutral | as recorded (R3) | R6-nh-34: Only own-data recomputations are carved out; PD-048 stands as narrowed |
| TD-041 | accept | C (reviewer: B) | neutral | as recorded (R3) | E08 |
| TD-046 | accept | C | neutral | as recorded (R3) | E08; R6-nh-10: Relocate and re-word the three doc comments |
| TD-047 | accept | C | neutral | as recorded (R3) | E08; R6-nh-16: One extracted tests.rs per module, matching the sibling convention |
| TD-048 | accept | C (reviewer: B) | neutral | as recorded (R3) | E08; R6-nh-17: Parameterize in place now; the fold is E08's grouping call |
| TD-050 | accept | C | neutral | as recorded (R3) | E08 |
| TD-051 | accept | C (reviewer: B) | neutral | as recorded (R3) | E08; R6-nh-24: Delete the redundant binary now |
| TD-052 | accept | C (reviewer: B) | neutral | as recorded (R3) | E08; R6-nh-43: Delete; provenance lives in git history |
| TD-055 | accept | C (reviewer: B) | neutral | as recorded (R3) | E08; R6-nh-35: Retire the checklist to prose |
| TD-056 | accept | C | neutral | as recorded (R3) | E08; R6-nh-36: Final: keep the pair; destination per NH25; R6-nh-37: Deliberate; state the why in one doc clause |

**Holds (`conflicts`).** CD-024-successor — take-the-alternative (R4): Take the alternative (Recommended) — die: the per-rank derivation stays; CD-024-successor rides CD-004's single Config projection; no broadcast seam, no id promoted; the hold closes as subsumed. Not in the actionable set as a seam; no id promoted.

**Re-baseline decisions.** CD-005 — accept-with-rebaseline (R5): Accept with re-baseline (Recommended) — CD-005 stays accepted; the fix lands only behind a parity re-baseline that names all three bars, with the NCS fields moved as one unit. Bar: parity goldens (parity_hash_highs / parity_hash_clp); rank-invariance harness (tests/common/permute.rs); mpiexec -n 1/2 reproduction.

**Cleared by this gate (do not re-raise):** the three ratified retires — CD-001 (`b051c410`), the CD-003 Construction hop (`4075c4e8`), CD-006 (`3f4c3db3`) — moved into the Cleared list above with their closing commits; no entry was rejected.

**Presented read-only, no decision taken:** the 16 defender dismissals, the 10 dup-of folds and the five reserved-seam filters (gate.md §1.5); no question offered.

**Needs-human answers (43/43):** see `gate.md` §3.4 and the `Owner decision` bullet on each entry — set_budget removed and dropped from the rules line (NH1); ResolvedParameters::get stays infallible (NH2); warm_start_cuts, Col/Row, FphaRowRange and the public alias half batched into one licensed public-API break (NH3, NH12, NH13, NH27); enumerated + DCS rejected at admission, eviction reader in scope, B (A-risk) (NH19, NH20); CD-084 latent, byte-neutral (NH38); CD-005 keeps NCS as one unit (R5); PD-035 symmetric fill only (NH5); PD-036 NodeGraph field (NH6); PD-039 warm-start-chain bars (NH15); PD-042 over-inclusion kept (NH23); PD-045 StageContext span (NH32); PD-043 recount kept (NH42); rule-11 own-data reading (NH34); test-corpus directions on TD-042/044/045/047/048/049/051/052/053/054/055/056; CD-085 trigger 4 bounded (NH11); CD-088 lands with 0a (NH28); OD-041 crate-wide pass (NH31); OD-040 prose down to D4 and residue re-filed to cobre-io (NH29, NH30).

**Informational (no id):** two setup-time FPHA-fitting residues (NH33, for E10, no track); hull/ as a second unsafe island — crate-root forbid + per-module allow and the CLAUDE.md enumeration (NH40, E07/E11); CutSelectionStrategy::Dynamic k2 / nadic field docs reversed (NH41, E07); invariance-shuffle.yml builds the parity binary without test-support (NH9, E07).

**Gate: RETURNED 2026-09-18** — baseline `077dbe2c`; accepted 44, amended 0, downgraded 0, rejected 0, deferred 0, overridden 0; 22 prior ids ratified (3 retire → Cleared, 11 keep, 8 sharpen); 1 hold closed by its alternative; 1 re-baseline accepted; 43 needs-human answered.
...
- **Owner decision (2026-09-18, R6-nh-2):** Construction-time check, get stays infallible — the fail-loud leg is enforced at the LP-build / admission-gate site riding the CD-004 single-projection carrier; ResolvedParameters::get keeps its infallible pub must_use signature
...
- **Owner decision (2026-09-18, R6-nh-3):** Remove, batched with the public-API break — CutManagementConfig::warm_start_cuts is deleted in the same licensed public-API break as OD-037 / OD-038 (CD-019 batching precedent); the false doc line is corrected now
- **Byte-neutrality:** asserted against the parity goldens (`parity_hash_highs` / `parity_hash_clp` in the sddp parity binary), the rank-invariance harness (tests/common/permute.rs) and `mpiexec -n 1/2` reproduction.
...
- **Alignment:** neutral (provisional; Epic 9 adjudicates against the L0-L4 target layering — plans/generalizing/beyond-sddp-generalization.md Part IV §IV.1 (L3 engine internals))
- **Owner decision (2026-09-18, R6-nh-5):** Symmetric fill only, no re-baseline — PD-035's fix-shape narrows to the byte-exact half (mirrored distance matrix, hoisted per-start buffers); the tour-cost delta reformulation is dropped, no parity re-baseline; setup-time, stays Sev C, not queued
- **Byte-neutrality:** asserted against the parity goldens (`parity_hash_highs` / `parity_hash_clp` in the sddp parity binary), the rank-invariance harness (tests/common/permute.rs) and `mpiexec -n 1/2` reproduction.
...
- **Owner decision (2026-09-18, R6-nh-6):** NodeGraph field, land with the accessor residue — decision-tree rule 2: the cut-level decomposition becomes a NodeGraph field beside n_pools / pool_stage, reaching the backward drivers through TrainingContext; landed in the same change as the interior-cut-node accessor one-owner residue
- **Byte-neutrality:** asserted against the parity goldens (`parity_hash_highs` / `parity_hash_clp` in the sddp parity binary), the rank-invariance harness (tests/common/permute.rs) and `mpiexec -n 1/2` reproduction.
...
- **Alignment:** neutral (provisional; Epic 9 adjudicates against the L0-L4 target layering — plans/generalizing/beyond-sddp-generalization.md Part IV §IV.1 (L3 engine internals))
- **Owner decision (2026-09-18, R6-nh-7):** Uniform spread + one canary literal; no Default derive — the fix stays a test-support constructor (..HydroPenalties::uniform(v) spread) with one full sixteen-field literal kept per crate as the compile-time canary; no Default derive in cobre-core
- **Byte-neutrality:** asserted against the parity goldens (`parity_hash_highs` / `parity_hash_clp` in the sddp parity binary), the rank-invariance harness (tests/common/permute.rs) and `mpiexec -n 1/2` reproduction.
...
- **Alignment:** neutral (provisional; Epic 9 adjudicates against the L0-L4 target layering — plans/generalizing/beyond-sddp-generalization.md Part IV §IV.1 (L3 engine internals))
- **Owner decision (2026-09-18, R6-nh-8):** Per-binary hoist now; cross-binary lift is E08's call — the in-file duplicates collapse at file scope in each binary; whether the shared class lifts into tests/common follows the E08 test-corpus convention decision
- **Byte-neutrality:** asserted against the parity goldens (`parity_hash_highs` / `parity_hash_clp` in the sddp parity binary), the rank-invariance harness (tests/common/permute.rs) and `mpiexec -n 1/2` reproduction.
...
- **Owner decision (2026-09-18, R6-nh-9):** Consolidate behind test-support; E07 fixes the workflow — the shared state_layout_for lives in the test-support surface; invariance-shuffle.yml's missing --features test-support on the parity binary is handed to the build-ci station (E07) as a CI drift item
- **Byte-neutrality:** asserted against the parity goldens (`parity_hash_highs` / `parity_hash_clp` in the sddp parity binary), the rank-invariance harness (tests/common/permute.rs) and `mpiexec -n 1/2` reproduction.
...
- **Alignment:** neutral (provisional; Epic 9 adjudicates against the L0-L4 target layering — plans/generalizing/beyond-sddp-generalization.md Part IV §IV.1 (L3 engine internals))
- **Owner decision (2026-09-18, R6-nh-10):** Relocate and re-word the three doc comments — the lag-shift oracle leaves stochastic/noise.rs and the three production doc comments (noise.rs:211, state_space.rs:443, cut_state_projection.rs:269) describe the kernel by behaviour instead of naming the test oracle; no behaviour change
- **Byte-neutrality:** n/a — test-only, visibility-only or doc-only change; no rendered LP byte can move (bounded by the parity goldens (`parity_hash_highs` / `parity_hash_clp` in the sddp parity binary), the rank-invariance harness (tests/common/permute.rs) and `mpiexec -n 1/2` reproduction as a formality).
...
- **Owner decision (2026-09-18, R6-nh-38):** Rejected at validation; latent, fix byte-neutral — an anticipated plant with a fixed post-horizon window AND an in-study decision above it is not a valid deck (rejected at validation), so CD-084's raw-axis residue is latent; CD-084 stays B (A-risk) as calibrated and the one-site ring-axis correction lands byte-neutral against every golden
...
- **Owner decision (2026-09-18, R6-nh-11):** Bounded to seams/traits/crates; the accessor is fine — conflicts trigger 4 does not reach a family-completing StateSpace accessor; CD-085 stays accepted at B, advances-0b, no hold; recorded on the E9 alignment queue
- **Byte-neutrality:** asserted against the parity goldens (`parity_hash_highs` / `parity_hash_clp` in the sddp parity binary), the rank-invariance harness (tests/common/permute.rs) and `mpiexec -n 1/2` reproduction.
...
- **Alignment:** neutral (provisional; Epic 9 adjudicates against the L0-L4 target layering — plans/generalizing/beyond-sddp-generalization.md Part IV §IV.1 (L3 engine internals))
- **Owner decision (2026-09-18, R6-nh-15):** Treat as a warm-start-chain change; clear all three bars in E10 — PD-039's hoist is measured by the perf sweep at 4t and lands only with the parity goldens, the rank-invariance harness and the opening_order_determinism gate green; nothing asserted at the gate
...
- **Owner decision (2026-09-18, R6-nh-12):** Batch with the next licensed public-API break / 0b carve — OD-037's Col/Row removal ships in the same licensed public-API break as OD-038 and CD-083 (CD-019 batching precedent); the defect is settled, only the scheduling is batched
- **Byte-neutrality:** asserted against the parity goldens (`parity_hash_highs` / `parity_hash_clp` in the sddp parity binary), the rank-invariance harness (tests/common/permute.rs) and `mpiexec -n 1/2` reproduction.
...
- **Alignment:** advances-0b (provisional; Epic 9 adjudicates against the L0-L4 target layering — plans/generalizing/beyond-sddp-generalization.md Part IV §IV.2 (lp/ indexer moves with the cobre-model carve-out))
- **Owner decision (2026-09-18, R6-nh-13):** Batch with the next licensed public-API break / 0b carve — OD-038's FphaRowRange removal ships in the same licensed public-API break as OD-037 and CD-083; the false module doc is corrected now
- **Owner decision (2026-09-18, R6-nh-14):** Joins OD-038 — one doc-correction step covers the FphaRowRange module doc and BlockGrid::advance_fpha_base's rustdoc (block_grid.rs:106-107); lands now, independent of the removal's batching
- **Byte-neutrality:** asserted against the parity goldens (`parity_hash_highs` / `parity_hash_clp` in the sddp parity binary), the rank-invariance harness (tests/common/permute.rs) and `mpiexec -n 1/2` reproduction.
...
- **Owner decision (2026-09-18, R6-nh-16):** One extracted tests.rs per module, matching the sibling convention — TD-047's split follows the three extracted-tests siblings in lp/builder (commitment_reconcile / layout / template); recorded as CD-007's convention decision
- **Byte-neutrality:** n/a — test-only, visibility-only or doc-only change; no rendered LP byte can move (bounded by the parity goldens (`parity_hash_highs` / `parity_hash_clp` in the sddp parity binary), the rank-invariance harness (tests/common/permute.rs) and `mpiexec -n 1/2` reproduction as a formality).
...
- **Alignment:** neutral (provisional; Epic 9 adjudicates against the L0-L4 target layering — plans/generalizing/beyond-sddp-generalization.md Part IV §IV.1 (L3 engine internals))
- **Owner decision (2026-09-18, R6-nh-17):** Parameterize in place now; the fold is E08's grouping call — build_classical_fixture collapses onto build_par_a_fixture inside the binary now; folding onto two_hydro_par_system follows the E08 section 5.1 grouping decision
- **Byte-neutrality:** n/a — test-only, visibility-only or doc-only change; no rendered LP byte can move (bounded by the parity goldens (`parity_hash_highs` / `parity_hash_clp` in the sddp parity binary), the rank-invariance harness (tests/common/permute.rs) and `mpiexec -n 1/2` reproduction as a formality).
...
- **Alignment:** neutral (provisional; Epic 9 adjudicates against the L0-L4 target layering — plans/generalizing/beyond-sddp-generalization.md Part IV §IV.1 (L3 engine internals))
- **Owner decision (2026-09-18, R6-nh-18):** Spec-layer extension, with the collapse as its first step — TD-049's ticket targets the O(1) Spec-layer extension to InflowModel, LoadModel and the four sizing structs, which owns the remaining fan-out; the nineteen-builder collapse lands as its first step
- **Byte-neutrality:** n/a — test-only, visibility-only or doc-only change; no rendered LP byte can move (bounded by the parity goldens (`parity_hash_highs` / `parity_hash_clp` in the sddp parity binary), the rank-invariance harness (tests/common/permute.rs) and `mpiexec -n 1/2` reproduction as a formality).
...
- **Owner decision (2026-09-18, R6-nh-19):** Road (a): reject the pairing at admission — enumerated traversal + dynamic cut selection is NOT a supported configuration: it becomes a typed admission-gate rejection beside the existing enumerated preconditions in setup/mod.rs, never a silent degrade; no new collective
- **Owner decision (2026-09-18, R6-nh-20):** In scope; severity stays B (A-risk) — CutPool::enforce_budget's eviction-key reader is inside CD-086's scope; road (a) covers both readers; severity stays B (A-risk), the marker already carrying the bound hazard; no separate item
- **Byte-neutrality:** asserted against the parity goldens (`parity_hash_highs` / `parity_hash_clp` in the sddp parity binary), the rank-invariance harness (tests/common/permute.rs) and `mpiexec -n 1/2` reproduction.
...
- **Owner decision (2026-09-18, R6-nh-22):** Correct the sentence inside PD-040's fix — the false 'no heap allocation' rustdoc at training/session/mod.rs:1026-1027 is made true in the same change that removes or documents run_cut_management's allocations; no extra id
- **Byte-neutrality:** asserted against the parity goldens (`parity_hash_highs` / `parity_hash_clp` in the sddp parity binary), the rank-invariance harness (tests/common/permute.rs) and `mpiexec -n 1/2` reproduction.
...
- **Owner decision (2026-09-18, R6-nh-23):** Keep the over-inclusion; shared-block fix only — the level-wide over-inclusion is a required correctness margin; PD-042 is exactly the byte-neutral one-block-per-level fix; narrowing each node's archive to its routed states is NOT licensed
- **Byte-neutrality:** asserted against the parity goldens (`parity_hash_highs` / `parity_hash_clp` in the sddp parity binary), the rank-invariance harness (tests/common/permute.rs) and `mpiexec -n 1/2` reproduction.
...
- **Owner decision (2026-09-18, R6-nh-42):** Keep the unconditional recount; PD-043 is the slot-table clear only — enforce_basic_count_invariant's BASIC recount stays an unconditional release check; PD-043's fix-shape is the reconstructed-slots-only clear of the slot table; no debug_assert demotion
- **Byte-neutrality:** asserted against the parity goldens (`parity_hash_highs` / `parity_hash_clp` in the sddp parity binary), the rank-invariance harness (tests/common/permute.rs) and `mpiexec -n 1/2` reproduction.
...
- **Alignment:** neutral (provisional; Epic 9 adjudicates against the L0-L4 target layering — plans/generalizing/beyond-sddp-generalization.md Part IV §IV.1 (L3 engine internals))
- **Owner decision (2026-09-18, R6-nh-41):** Route the two-comment correction to E07 — the reversed field docs on CutSelectionStrategy::Dynamic (k2 / nadic) are a rustdoc drift item for the build-ci/docs station; no id at this station; the config mapping is correct
- **Byte-neutrality:** asserted against the parity goldens (`parity_hash_highs` / `parity_hash_clp` in the sddp parity binary), the rank-invariance harness (tests/common/permute.rs) and `mpiexec -n 1/2` reproduction.
...
- **Alignment:** neutral (provisional; Epic 9 adjudicates against the L0-L4 target layering — plans/generalizing/beyond-sddp-generalization.md Part IV §IV.1 (L3 engine internals))
- **Owner decision (2026-09-18, R6-nh-24):** Delete the redundant binary now — the duplicate sync_cuts count-mismatch binary is deleted now (coverage-neutral, independent of the API break); the surviving copy retires with the superseded method
- **Byte-neutrality:** n/a — test-only, visibility-only or doc-only change; no rendered LP byte can move (bounded by the parity goldens (`parity_hash_highs` / `parity_hash_clp` in the sddp parity binary), the rank-invariance harness (tests/common/permute.rs) and `mpiexec -n 1/2` reproduction as a formality).
...
- **Alignment:** neutral (provisional; Epic 9 adjudicates against the L0-L4 target layering — plans/generalizing/beyond-sddp-generalization.md Part IV §IV.1 (L3 engine internals))
- **Owner decision (2026-09-18, R6-nh-43):** Delete; provenance lives in git history — tests/test_mpi_allgatherv_nonuniform_workers.rs is deleted (coverage-neutral); the historical nonuniform-workers bug stays traceable through git history and the surviving handshake_rejects_nonuniform_workers unit test
- **Byte-neutrality:** n/a — test-only, visibility-only or doc-only change; no rendered LP byte can move (bounded by the parity goldens (`parity_hash_highs` / `parity_hash_clp` in the sddp parity binary), the rank-invariance harness (tests/common/permute.rs) and `mpiexec -n 1/2` reproduction as a formality).
...
- **Owner decision (2026-09-18, R6-nh-25):** cobre-sddp test-support surface — the genericity hard rule decides: Rank0Of2 names cobre-sddp's RankDistribution, so the StubComm / Rank0Of2 pair lives in cobre-sddp's test_support; a later StubComm move to a cobre-comm test-support feature is E08-2's call
- **Byte-neutrality:** n/a — test-only, visibility-only or doc-only change; no rendered LP byte can move (bounded by the parity goldens (`parity_hash_highs` / `parity_hash_clp` in the sddp parity binary), the rank-invariance harness (tests/common/permute.rs) and `mpiexec -n 1/2` reproduction as a formality).
...
- **Alignment:** neutral (provisional; Epic 9 adjudicates against the L0-L4 target layering — plans/generalizing/beyond-sddp-generalization.md Part IV §IV.1 (L3 engine internals))
- **Owner decision (2026-09-18, R6-nh-26):** cfg-gated declarative macro in test_support.rs — one cfg-gated macro stamps the inert MockSolver body; the seven-to-one get_basis site and the two strict sites keep their own doubles
- **Byte-neutrality:** n/a — test-only, visibility-only or doc-only change; no rendered LP byte can move (bounded by the parity goldens (`parity_hash_highs` / `parity_hash_clp` in the sddp parity binary), the rank-invariance harness (tests/common/permute.rs) and `mpiexec -n 1/2` reproduction as a formality).
...
- **Owner decision (2026-09-18, R6-nh-28):** Land with 0a's shared output orchestration — CD-088 stays accepted at C, advances-0a; the write-payload conversion moves when Phase 0a's shared output orchestration in cobre-io absorbs the engine-to-io projection, not as an intra-engine move 0a would undo
- **Byte-neutrality:** asserted against the parity goldens (`parity_hash_highs` / `parity_hash_clp` in the sddp parity binary), the rank-invariance harness (tests/common/permute.rs) and `mpiexec -n 1/2` reproduction.
...
- **Alignment:** neutral (provisional; Epic 9 adjudicates against the L0-L4 target layering — plans/generalizing/beyond-sddp-generalization.md Part IV §IV.1 (L3 engine internals))
- **Owner decision (2026-09-18, R6-nh-32):** StageContext, span-only — PD-045's per-stage unscaled cache lives on StageContext as a load-balance-rows span (shared immutable per-stage data, the context-struct pattern); not per-worker scratch
- **Byte-neutrality:** asserted against the parity goldens (`parity_hash_highs` / `parity_hash_clp` in the sddp parity binary), the rank-invariance harness (tests/common/permute.rs) and `mpiexec -n 1/2` reproduction.
...
- **Owner decision (2026-09-18, R6-nh-29):** Correct the mirror sentence down to D4 — the mirror :1278-1284 sentence stops asserting an every-site Rationale on numeric-cast allows and states the comments.md D4 lint scope; no new obligation on the 42 cast_* openers; routed to E11's mirror write-back with NH4
- **Owner decision (2026-09-18, R6-nh-30):** Re-file the residue against cobre-io at E11 — OD-040 stays accepted here as the record; the four cast_sign_loss sites are a missing cobre-io input-boundary validation and are re-filed against cobre-io at the reconciliation epic
- **Byte-neutrality:** asserted against the parity goldens (`parity_hash_highs` / `parity_hash_clp` in the sddp parity binary), the rank-invariance harness (tests/common/permute.rs) and `mpiexec -n 1/2` reproduction.
...
- **Alignment:** neutral (provisional; Epic 9 adjudicates against the L0-L4 target layering — plans/generalizing/beyond-sddp-generalization.md Part IV §IV.1 (L3 engine internals))
- **Owner decision (2026-09-18, R6-nh-31):** Crate-wide pass over the 25 sites with a forcing check — OD-041 widens to one crate-wide visibility pass over the 25 single-file pub(crate) items, each narrowed only where a per-site forcing check proves no other consumer; stays Sev C
- **Byte-neutrality:** asserted against the parity goldens (`parity_hash_highs` / `parity_hash_clp` in the sddp parity binary), the rank-invariance harness (tests/common/permute.rs) and `mpiexec -n 1/2` reproduction.
...
- **Alignment:** neutral (provisional; Epic 9 adjudicates against the L0-L4 target layering — plans/generalizing/beyond-sddp-generalization.md Part IV §IV.1 (L3 engine internals))
- **Owner decision (2026-09-18, R6-nh-35):** Retire the checklist to prose — hold_k1_byte_stability_probe.rs is retired; the audited k_max partition becomes a short prose note in the testing-architecture doc; no executable gate
- **Byte-neutrality:** n/a — test-only, visibility-only or doc-only change; no rendered LP byte can move (bounded by the parity goldens (`parity_hash_highs` / `parity_hash_clp` in the sddp parity binary), the rank-invariance harness (tests/common/permute.rs) and `mpiexec -n 1/2` reproduction as a formality).
...
- **Alignment:** neutral (provisional; Epic 9 adjudicates against the L0-L4 target layering — plans/generalizing/beyond-sddp-generalization.md Part IV §IV.1 (L3 engine internals))
- **Owner decision (2026-09-18, R6-nh-36):** Final: keep the pair; destination per NH25 — testing-architecture section 5.8 is ratified for the StubComm / Rank0Of2 pair; the merge half stays dismissed; the destination is cobre-sddp's test_support (NH25), not cobre-comm
- **Owner decision (2026-09-18, R6-nh-37):** Deliberate; state the why in one doc clause — conformance.rs:40 LocalComm's no-copy collectives are semantics by design; its rustdoc gains the single clause explaining the divergence from tests/common StubComm; no behaviour change
- **Byte-neutrality:** n/a — test-only, visibility-only or doc-only change; no rendered LP byte can move (bounded by the parity goldens (`parity_hash_highs` / `parity_hash_clp` in the sddp parity binary), the rank-invariance harness (tests/common/permute.rs) and `mpiexec -n 1/2` reproduction as a formality).
