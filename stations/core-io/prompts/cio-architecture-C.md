...
Baseline: `a136840d4f2ea137f685f0af6dac04254b983b60`   Sub-station: `C`   Lens: `architecture`
Sweep ONLY these paths (repo-relative; a nested directory is listed with its parent and is in scope): `crates/cobre-io/src/config`, `crates/cobre-io/src/validation`, `crates/cobre-io/src/validation/semantic`, `crates/cobre-io/src/schema.rs`, `crates/cobre-io/src/error.rs`, `crates/cobre-io/src/lib.rs`
