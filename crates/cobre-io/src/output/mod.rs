...
pub use manifest::{
    ...
    write_simulation_metadata, write_training_metadata, DistributionInfo, MetadataConfiguration,
    MetadataConvergence, MetadataCuts, MetadataIterations, MetadataProblemDimensions,
    MetadataScenarios, OutputContext, SimulationMetadata, TrainingMetadata,
};
