...
Baseline: `a136840d4f2ea137f685f0af6dac04254b983b60`   Sub-station: `B`   Lens: `architecture`
Sweep ONLY these paths (repo-relative; a nested directory is listed with its parent and is in scope): `crates/cobre-io/src/system`, `crates/cobre-io/src/scenarios`, `crates/cobre-io/src/scenarios/estimation`, `crates/cobre-io/src/extensions`, `crates/cobre-io/src/constraints`, `crates/cobre-io/src/resolution`, `crates/cobre-io/src/stages.rs`, `crates/cobre-io/src/stage_resolve.rs`, `crates/cobre-io/src/initial_conditions.rs`, `crates/cobre-io/src/windowed_history.rs`, `crates/cobre-io/src/post_study_stages.rs`, `crates/cobre-io/src/penalties.rs`, `crates/cobre-io/src/broadcast.rs`
...
run is `architecture`; the other three lenses are covered by sibling workers, so stay inside your lens and
