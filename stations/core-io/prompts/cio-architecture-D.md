...
Baseline: `a136840d4f2ea137f685f0af6dac04254b983b60`   Sub-station: `D`   Lens: `architecture`
Sweep ONLY these paths (repo-relative; a nested directory is listed with its parent and is in scope): `crates/cobre-io/src/output`, `crates/cobre-io/src/output/policy`, `crates/cobre-io/src/parquet_helpers.rs`, `crates/cobre-io/src/pipeline.rs`, `crates/cobre-io/src/report.rs`
