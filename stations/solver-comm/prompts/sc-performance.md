...
Baseline: `077dbe2c287b92c2d0c6a12d5f67c2c0cb83c39c`   Station: `solver-comm`   Lens: `performance`
...
for this run is `performance`; the other three lenses are covered by sibling workers, so stay inside
