...
///
/// 18 columns. One row per (iteration, phase, stage) triple.
pub(crate) fn solver_iterations_schema() -> Schema {
    Schema::new(vec![
        ...
        Field::new("basis_padding_tight", DataType::UInt64, false),
        Field::new("basis_padding_slack", DataType::UInt64, false),
    ])
}
